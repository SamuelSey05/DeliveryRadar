...
class DBController:
    ...
    def connect(self) -> None:
        ...
        if LOCAL_TEST:
            ...
            try:
                self.connection = connector.connect(host=DatabaseSecrets.host, user=DatabaseSecrets.user, password=DatabaseSecrets.password, database=DatabaseSecrets.database)
            except:
                err()
                raise DBConnectionFailure()
