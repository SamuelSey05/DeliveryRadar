import { h, r as registerInstance, c as createEvent, H as Host, g as getElement, F as Fragment } from './index-9a614de1.js';
import { D as DEFAULTS, P as PHRASE_PARAMETER_PLACEHOLDER, d as dist, r as resources, s as sdk, W as W3W_REGEX, b as SELECTORS, w as what3wordsClients, M as MAP_SCRIPT_ID, R as RETRIES, e as MIN_GRID_ZOOM_LEVEL, f as MARKER_SRC, g as DEFAULT_LIBS$1, T as TOP_LEFT, h as SELECTED_ZOOM_LEVEL, j as SEARCH_CONTROL_SELECTOR, C as CURRENT_LOCATION_CONTROL_SELECTOR, k as MAP_TYPE_CONTROL_SELECTOR, Z as ZOOM_CONTROL_SELECTOR, l as MAP_SELECTOR, A as AUTOSUGGEST_SELECTOR, m as W3W_TEXTAREA_REGEX, n as W3W_TEXTAREA_PROPERTIES } from './index-c9f2fa76.js';
import { i as isEmpty, c as convertToCoordinates, u as utilisation, S as SessionType, p as parseCoordinates } from './utilisation-56fb7f8e.js';
...
function getPhraseTranslations(languageCode) {
  ...
  const translations = (resources === null || resources === void 0 ? void 0 : resources[(_a = LANGUAGE_MAP[languageCode]) === null || _a === void 0 ? void 0 : _a[detectedLanguage.toLowerCase()]]) ||
    (resources === null || resources === void 0 ? void 0 : resources[dist.baseLanguageCodeForISO6391(languageCode)]) ||
...
function getApiLanguageCodeFromLanguageMap(languageCode) {
  ...
  const apiLanguageCode = Object.keys(LANGUAGE_MAP).find(key => { var _a; return (_a = LANGUAGE_MAP[key]) === null || _a === void 0 ? void 0 : _a[languageCode.toLowerCase()]; }) ||
    dist.baseLanguageCodeForISO6391(languageCode) ||
    (dist.validLanguage(languageCode) && languageCode);
...
function resolveLanguageCode(languageCode) {
  ...
  if (!dist.validLanguage(languageCode)) {
    console.warn(`Invalid or unsupported language (\`${languageCode}\`), using default language (\`${DEFAULTS.language}\`) for autosuggest results instead.`);
...
const ErrorMessage = props => {
  ...
  const width = props.offsetWidth
    ...
    : undefined;
  return (h("div", { class: `${c$3}-error-wrapper`, style: { width }, "data-testid": "error-wrapper" },
    h("div", { class: `${c$3}-error`, "data-testid": "error" },
      h("div", { class: `${c$3}-message` }, props.error.message))));
};
...
const Status$1 = props => {
  const top = props.offsetHeight
    ...
    : undefined;
  return (h("span", { class: props.class, "data-testid": "state", 
...
const CustomSuggestion = (_a) => {
  ...
  return (h("div", Object.assign({}, props),
    h("div", { class: `${c$2}-address` },
      h("div", { class: `${c$2}-words`, "data-testid": "words-", style: { marginLeft: '16px' } }, value)),
    h("div", { class: `${c$2}-nearest-place`, "data-testid": "nearest-place" },
      h("div", { class: `${c$2}-nearest-place-text`, "data-testid": "nearest-place-text" },
        h("div", null, description ? description.trim() : ''),
        distance ? (h("div", { class: `${c$2}-nearest-place-distance`, "data-testid": "nearest-place-distance" },
          distance,
          units)) : null))));
};
...
const W3wSuggestion$1 = (_a) => {
  ...
  return (h("div", Object.assign({}, props),
    h("div", { class: `${c$1}-address`, "data-testid": "address" },
      h("what3words-symbol", { size: DEFAULTS.iconSize, color: DEFAULTS.iconColor }),
      h("div", { class: `${c$1}-words`, "data-testid": "words" }, words)),
    h("div", { class: `${c$1}-nearest-place`, "data-testid": "nearest-place" },
      country.toLowerCase() === 'zz' ? (h("div", { class: `${c$1}-flag ${c$1}-flag-${country.toLowerCase()}`, "data-testid": "flag" })) : null,
      h("div", { class: `${c$1}-nearest-place-text`, "data-testid": "nearest-place-text" },
        nearestPlace && (h("div", null, t('nearest_place', {
          param: nearestPlace,
          language,
          strict: false,
        }))),
        distanceToFocusKm ? (h("div", { class: `${c$1}-nearest-place-distance`, "data-testid": "nearest-place-distance" },
          distanceToFocusKm,
          " km")) : null))));
};
...
const Suggestions$1 = (_a) => {
  ...
  const W3wSuggestions = () => suggestions.map((opt, i) => {
    ...
    if (hoverIndex === i)
      classes.push('active');
    const onMouseDown = (e) => e.preventDefault();
    return (h(W3wSuggestion$1, { opt: opt, class: classes.join(' '), onMouseDown: onMouseDown, onMouseUp: onW3wSuggestionSelected(opt), onMouseOver: onMouseOver(opt), onMouseOut: onMouseOut, "data-testid": 'suggestion-' + i }));
  });
  const width = offsetWidth ? String(offsetWidth) + 'px' : undefined;
  return (h("div", { class: rest.class, "data-testid": "suggestions-wrapper" },
    h("div", { class: `${c}-items`, 
      ...
      style: { width } },
      suggestions.length ? h(W3wSuggestions, null) : null,
      options.length ? h(CustomOptions, null) : null)));
};
...
const What3wordsAutosuggest = class {
  constructor(hostRef) {
    ...
    this.value_changed = createEvent(this, "value_changed", 7);
    this.value_valid = createEvent(this, "value_valid", 7);
    this.value_invalid = createEvent(this, "value_invalid", 7);
    this.selected_suggestion = createEvent(this, "selected_suggestion", 7);
    this.suggestions_changed = createEvent(this, "suggestions_changed", 7);
    this.suggestions_not_found = createEvent(this, "suggestions_not_found", 7);
    this.coordinates_changed = createEvent(this, "coordinates_changed", 7);
    this.selected_custom_option = createEvent(this, "selected_custom_option", 7);
    this.deselected_suggestion = createEvent(this, "deselected_suggestion", 7);
    this.__hover = createEvent(this, "__hover", 7);
    this.__focus = createEvent(this, "__focus", 7);
    this.__blur = createEvent(this, "__blur", 7);
    this.__error = createEvent(this, "__error", 7);
    var _a;
    ...
    this.api_version = dist.ApiVersion.Version3;
  ...
  connectedCallback() {
    ...
    const transport = dist.fetchTransport();
    this.clients = {
...
const What3wordsMap = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
    this.selected_square = createEvent(this, "selected_square", 7);
    this.coordinates_changed = createEvent(this, "coordinates_changed", 7);
    this.__load = createEvent(this, "__load", 7);
    this.__error = createEvent(this, "__error", 7);
    var _a;
    this.api_key = DEFAULTS.emptyString;
    this.headers = DEFAULTS.headers;
...
const Status = ({ tag, isLoadingSelected3waCount, selected3waCount, showHintsTooltip, toggleTooltip, }) => {
  return (h("button", { type: "button", class: {
    ...
    h("img", { class: { [`${tag}-status-logo`]: !!tag }, src: what3wordsLogoSvg, alt: "what3words logo" }),
    h("div", { class: {
...
const Header = (_a) => {
  ...
  return (h("header", { style: style, class: {
      [`${tag}-header`]: !!tag,
      [props.class]: !!props.class,
    } },
    h("img", { class: { [`${tag}-header-logo`]: !!tag }, src: what3wordsLogoSvg, height: 14, alt: "what3words logo" }),
    h("button", { class: { [`${tag}-header-close-button`]: !!tag }, type: "button", "aria-label": "Close suggestions", onClick: onClose },
      h("img", { src: closeButtonSvg, height: 16, width: 16, alt: "close icon" }))));
};
...
const W3wSuggestion = (_a) => {
  ...
  return (h("li", Object.assign({}, props),
    h("div", { class: `${tag}-address`, "data-testid": "address" },
      h("what3words-symbol", { size: 14, color: DEFAULTS.iconColor }),
      h("div", { class: `${tag}-words`, "data-testid": "words" }, opt.words)),
    h("div", { class: `${tag}-nearest-place`, "data-testid": "nearest-place" },
      h("div", { class: `${tag}-nearest-place-text`, "data-testid": "nearest-place-text" }, opt.nearestPlace ? (opt.nearestPlace) : (h("img", { class: `${tag}-sea-icon`, src: seaSvg, alt: "Ocean" }))),
      !isNaN(opt.distanceToFocusKm) && (h("div", { class: `${tag}-nearest-place-distance`, "data-testid": "nearest-place-distance" },
...
const W3wSuggestionsSkeleton = ({ tag, }) => (h(Fragment, null,
  h("li", { class: { [`${tag}-suggestion-skeleton`]: !!tag } },
    h("img", { src: suggestionSkeletonSvg, alt: "suggestion skeleton" })),
  h("li", { class: { [`${tag}-suggestion-skeleton`]: !!tag } },
    h("img", { src: suggestionSkeletonSvg, alt: "suggestion skeleton" })),
  h("li", { class: { [`${tag}-suggestion-skeleton`]: !!tag } },
    h("img", { src: suggestionSkeletonSvg, alt: "suggestion skeleton" }))));
const Suggestions = (_a) => {
  ...
  return (h("ul", { "data-testid": `${tag}-suggestions`, class: { [`${tag}-suggestions`]: !!tag }, 
    ...
    // border in autosuggest.scss you must also change it here accordingly.
    style: props.style },
    showSkeleton && h(W3wSuggestionsSkeleton, { tag: tag }),
    showSuggestions && (h(W3wSuggestions, { tag: tag, suggestions: suggestions, value: value, hoverIndex: hoverIndex, onMouseOver: onMouseOver, onMouseOut: onMouseOut, onSuggestionSelected: onSuggestionSelected })),
    showHeader && h(Header, { tag: tag, onClose: onClose })));
};

const Tooltip = ({ tag, style, onClose, }) => {
  return (h("section", { class: { [`${tag}-tooltip`]: !!tag }, style: style },
    h(Header, { tag: tag, onClose: onClose, style: {
        backgroundColor: 'white',
        borderRadius: '0.5rem',
        margin: '-8px -8px 0 -8px',
      } }),
    h("slot", { name: "tooltip" },
      h("h3", { class: { [`${tag}-tooltip-title`]: !!tag } }, "Did you know?"),
      h("p", { class: { [`${tag}-tooltip-description`]: !!tag } },
        "You can add a",
        ' ',
        h("a", { href: "https://delivery.w3w.co", target: "_blank", rel: "noopener noreferrer" }, "what3words"),
        ' ',
...
const What3wordsNotes = class {
  constructor(hostRef) {
    ...
    this.valueValid = createEvent(this, "valueValid", 7);
    this.valueInvalid = createEvent(this, "valueInvalid", 7);
    this.suggestionSelected = createEvent(this, "suggestionSelected", 7);
    this.suggestionsChanged = createEvent(this, "suggestionsChanged", 7);
    this.suggestionHover = createEvent(this, "suggestionHover", 7);
    this.apiError = createEvent(this, "apiError", 7);
    var _a, _b;
  ...
  async connectedCallback() {
    ...
    const transport = await import('./index-c9f2fa76.js').then(function (n) { return n.i; }).then(m => m.fetchTransport());
    if (!this.apiKey) {
...
const What3wordsSymbol = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
    this.color = DEFAULTS.iconColor;
    this.size = DEFAULTS.symbolSize;
  }
  render() {
    return (h(Host, null, h("svg", { viewBox: "0 0 32 32", class: "what3words-logo", style: {
        color: this.color,
        width: `${this.size}px`,
        height: `${this.size}px`,
      }, "data-testid": "what3words-symbol" }, h("path", { fill: "currentColor", d: "M10.7,4h2L4,28H2L10.7,4z M19.7,4h2L13,28h-2L19.7,4z M28.7,4h2L22,28h-2L28.7,4z" }))));
  }
};
What3wordsSymbol.style = symbolCss;

export { What3wordsAutosuggest as what3words_autosuggest, What3wordsMap as what3words_map, What3wordsNotes as what3words_notes, What3wordsSymbol as what3words_symbol };
