...
import { CustomOption } from "./components/autosuggest/domain";
import { CoordinatesPayload, InputValuePayload, SuggestionPayload, SuggestionsPayload } from "./components/autosuggest/autosuggest";
import { GoogleMapsLibraries, ThreeWordAddress } from "./components/map/domain";
import { ViewType } from "./components/map/providers/abstract";
import { W3wAddressFormat } from "./components/notes/notes";
import { InputValuePayload as InputValuePayload1, SuggestionPayload as SuggestionPayload1, SuggestionsPayload as SuggestionsPayload1 } from "./components/autosuggest/autosuggest";
export { ApiVersion, Coordinates, LocationJsonResponse } from "@what3words/api";
export { Variant } from "./lib";
export { CustomOption } from "./components/autosuggest/domain";
export { CoordinatesPayload, InputValuePayload, SuggestionPayload, SuggestionsPayload } from "./components/autosuggest/autosuggest";
export { GoogleMapsLibraries, ThreeWordAddress } from "./components/map/domain";
export { ViewType } from "./components/map/providers/abstract";
export { W3wAddressFormat } from "./components/notes/notes";
export { InputValuePayload as InputValuePayload1, SuggestionPayload as SuggestionPayload1, SuggestionsPayload as SuggestionsPayload1 } from "./components/autosuggest/autosuggest";
...
declare namespace LocalJSX {
    ...
    interface What3wordsNotes {
         ...
         */
        "onSuggestionHover"?: (event: What3wordsNotesCustomEvent<SuggestionPayload1>) => void;
        /**
          * Emitted when a suggestion is selected
          * @example { suggestion: { words: "filled.count.soap", [...] } }
         */
        "onSuggestionSelected"?: (event: What3wordsNotesCustomEvent<SuggestionPayload1>) => void;
        /**
          * Emitted when the suggestions change
         */
        "onSuggestionsChanged"?: (event: What3wordsNotesCustomEvent<SuggestionsPayload1>) => void;
        /**
          * Emitted when the input value changes
          * @example { value: "filled.count.s" }
         */
        "onValueChanged"?: (event: What3wordsNotesCustomEvent<InputValuePayload1>) => void;
        /**
          * Emitted when the input value is not a valid what3words address
          * @example { value: "filled,count,s" }
         */
        "onValueInvalid"?: (event: What3wordsNotesCustomEvent<InputValuePayload1>) => void;
        /**
          * Emitted when the input value is a valid what3words address
          * @example { value: "filled.count.soap" }
         */
        "onValueValid"?: (event: What3wordsNotesCustomEvent<InputValuePayload1>) => void;
        /**
          * The focus point to prioritize results around. If not provided, the user's current location is used.
          * @example "51.5412,-0.2477"
         */
