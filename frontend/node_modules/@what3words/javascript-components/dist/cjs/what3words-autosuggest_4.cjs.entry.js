...
const index$1 = require('./index-c574deb6.js');
const index = require('./index-c80d121f.js');
const utilisation = require('./utilisation-9fc0aaea.js');
...
function getPhraseTranslations(languageCode) {
  ...
  const translations = (index.resources === null || index.resources === void 0 ? void 0 : index.resources[(_a = LANGUAGE_MAP[languageCode]) === null || _a === void 0 ? void 0 : _a[detectedLanguage.toLowerCase()]]) ||
    (index.resources === null || index.resources === void 0 ? void 0 : index.resources[index.dist.baseLanguageCodeForISO6391(languageCode)]) ||
    (index.resources === null || index.resources === void 0 ? void 0 : index.resources[index.DEFAULTS.language]);
  return translations;
}
/**
...
function getApiLanguageCodeFromLanguageMap(languageCode) {
  ...
  const apiLanguageCode = Object.keys(LANGUAGE_MAP).find(key => { var _a; return (_a = LANGUAGE_MAP[key]) === null || _a === void 0 ? void 0 : _a[languageCode.toLowerCase()]; }) ||
    index.dist.baseLanguageCodeForISO6391(languageCode) ||
    (index.dist.validLanguage(languageCode) && languageCode);
  ...
  if (!apiLanguageCode) {
    console.warn(`Invalid or unsupported language (\`${languageCode}\`), using default language (\`${index.DEFAULTS.language}\`) for autosuggest results instead.`);
  }
  return apiLanguageCode || index.DEFAULTS.language;
}
/**
...
function t(key, opt = {}) {
  ...
  if (!translation && strict) {
    throw new Error(`No translations found for "${key}" key. Please add the translation to ${language} or "${index.DEFAULTS.language}" language file.`);
  }
  // if param is a string, attempt to inject into translation placeholder
  if (typeof param === 'string' && param.length > 0) {
    if (translation) {
      // inject if translation exists
      translation = translation.replace(index.PHRASE_PARAMETER_PLACEHOLDER, param);
    }
    else {
...
function resolveLanguageCode(languageCode) {
  ...
  if (!index.dist.validLanguage(languageCode)) {
    console.warn(`Invalid or unsupported language (\`${languageCode}\`), using default language (\`${index.DEFAULTS.language}\`) for autosuggest results instead.`);
    return index.DEFAULTS.language;
  }
...
const c$3 = 'what3words-autosuggest';
const ErrorMessage = props => {
  ...
  const width = props.offsetWidth
    ...
    : undefined;
  return (index$1.h("div", { class: `${c$3}-error-wrapper`, style: { width }, "data-testid": "error-wrapper" },
    index$1.h("div", { class: `${c$3}-error`, "data-testid": "error" },
      index$1.h("div", { class: `${c$3}-message` }, props.error.message))));
};
...
const Status$1 = props => {
  const top = props.offsetHeight
    ...
    : undefined;
  return (index$1.h("span", { class: props.class, "data-testid": "state", 
...
const c$2 = 'what3words-autosuggest';
const CustomSuggestion = (_a) => {
  var { distance, units, description, value } = _a, props = __rest$5(_a, ["distance", "units", "description", "value"]);
  return (index$1.h("div", Object.assign({}, props),
    index$1.h("div", { class: `${c$2}-address` },
      index$1.h("div", { class: `${c$2}-words`, "data-testid": "words-", style: { marginLeft: '16px' } }, value)),
    index$1.h("div", { class: `${c$2}-nearest-place`, "data-testid": "nearest-place" },
      index$1.h("div", { class: `${c$2}-nearest-place-text`, "data-testid": "nearest-place-text" },
        index$1.h("div", null, description ? description.trim() : ''),
        distance ? (index$1.h("div", { class: `${c$2}-nearest-place-distance`, "data-testid": "nearest-place-distance" },
          distance,
          units)) : null))));
};
...
const c$1 = 'what3words-autosuggest';
const W3wSuggestion$1 = (_a) => {
  var { opt } = _a, props = __rest$4(_a, ["opt"]);
  const { country, distanceToFocusKm, nearestPlace = '', words, language, } = opt || {};
  return (index$1.h("div", Object.assign({}, props),
    index$1.h("div", { class: `${c$1}-address`, "data-testid": "address" },
      index$1.h("what3words-symbol", { size: index.DEFAULTS.iconSize, color: index.DEFAULTS.iconColor }),
      index$1.h("div", { class: `${c$1}-words`, "data-testid": "words" }, words)),
    index$1.h("div", { class: `${c$1}-nearest-place`, "data-testid": "nearest-place" },
      country.toLowerCase() === 'zz' ? (index$1.h("div", { class: `${c$1}-flag ${c$1}-flag-${country.toLowerCase()}`, "data-testid": "flag" })) : null,
      index$1.h("div", { class: `${c$1}-nearest-place-text`, "data-testid": "nearest-place-text" },
        nearestPlace && (index$1.h("div", null, t('nearest_place', {
          param: nearestPlace,
          language,
          strict: false,
        }))),
        distanceToFocusKm ? (index$1.h("div", { class: `${c$1}-nearest-place-distance`, "data-testid": "nearest-place-distance" },
          distanceToFocusKm,
          " km")) : null))));
};
...
const Suggestions$1 = (_a) => {
  var { hoverIndex, value, suggestions, options, offsetWidth, onW3wSuggestionSelected, onCustomOptionSelected, onMouseOver, onMouseOut } = _a, rest = __rest$3(_a, ["hoverIndex", "value", "suggestions", "options", "offsetWidth", "onW3wSuggestionSelected", "onCustomOptionSelected", "onMouseOver", "onMouseOut"]);
  const CustomOptions = () => {
    return options.map((opt, i) => {
      ...
      return (index$1.h(CustomSuggestion, { distance: distance, units: units, description: description, value: opt.value, class: classes.join(' '), onMouseDown: onMouseDown, onMouseUp: onMouseUp, onMouseOver: onHover, "data-testid": 'suggestion-' + i }));
    });
  };
  const W3wSuggestions = () => suggestions.map((opt, i) => {
    ...
    if (hoverIndex === i)
      classes.push('active');
    const onMouseDown = (e) => e.preventDefault();
    return (index$1.h(W3wSuggestion$1, { opt: opt, class: classes.join(' '), onMouseDown: onMouseDown, onMouseUp: onW3wSuggestionSelected(opt), onMouseOver: onMouseOver(opt), onMouseOut: onMouseOut, "data-testid": 'suggestion-' + i }));
  });
  const width = offsetWidth ? String(offsetWidth) + 'px' : undefined;
  return (index$1.h("div", { class: rest.class, "data-testid": "suggestions-wrapper" },
    index$1.h("div", { class: `${c}-items`, 
...
const What3wordsAutosuggest = class {
  constructor(hostRef) {
    ...
    this.callback = index.DEFAULTS.emptyString;
    this.api_key = index.DEFAULTS.emptyString;
    this.headers = index.DEFAULTS.headers;
    this.base_url = ((_a = index.sdk.api.clients.autosuggest['_config']) === null || _a === void 0 ? void 0 : _a.host) || index.DEFAULTS.base_url;
    this.api_version = index.dist.ApiVersion.Version3;
    this.name = index.DEFAULTS.name;
    this.initial_value = index.DEFAULTS.emptyString;
    this.variant = index.DEFAULTS.variant;
    this.typeahead_delay = index.DEFAULTS.typeaheadDelay;
    this.invalid_address_error_message = index.DEFAULTS.null;
    this.strict = index.DEFAULTS.true;
    this.language = index.DEFAULTS.null;
    this.autosuggest_focus = index.DEFAULTS.emptyString;
    this.n_focus_results = index.DEFAULTS.null;
    this.clip_to_country = index.DEFAULTS.emptyString;
    this.clip_to_bounding_box = index.DEFAULTS.emptyString;
    this.clip_to_circle = index.DEFAULTS.emptyString;
    this.clip_to_polygon = index.DEFAULTS.emptyString;
    this.return_coordinates = index.DEFAULTS.coordinates;
    this.options = [];
    this.rawInput = this.initial_value;
    this.value = this.initial_value;
    this.input = index.DEFAULTS.null;
    this.latInput = index.DEFAULTS.null;
    this.lngInput = index.DEFAULTS.null;
    this.suggestions = index.DEFAULTS.options;
    this.selectedSuggestion = index.DEFAULTS.null;
    this.showSuggestions = index.DEFAULTS.false;
    this.hasFocus = index.DEFAULTS.false;
    this.latitude = index.DEFAULTS.null;
    this.longitude = index.DEFAULTS.null;
    this.apiRequest = index.DEFAULTS.null;
    this.loading = index.DEFAULTS.false;
    this.hoverIndex = -1;
    this.error = index.DEFAULTS.null;
    this.errorTimeout = index.DEFAULTS.null;
    this.clients = {};
  }
  /**
  ...
  getRequestOptions(input) {
    ...
    if (!utilisation.isEmpty(autosuggest_focus)) {
      const [lat, lng] = autosuggest_focus.split(',');
      options.focus = utilisation.parseCoordinates(lat, lng);
    }
    if (!utilisation.isEmpty(n_focus_results))
      options.nFocusResults = n_focus_results;
    if (!utilisation.isEmpty(clip_to_country))
      options.clipToCountry = clip_to_country.split(',');
    if (!utilisation.isEmpty(clip_to_bounding_box)) {
      const [southLat, westLng, northLat, eastLng] = clip_to_bounding_box.split(',');
      options.clipToBoundingBox = {
        northeast: utilisation.parseCoordinates(northLat, eastLng),
        southwest: utilisation.parseCoordinates(southLat, westLng),
      };
    }
    if (!utilisation.isEmpty(clip_to_circle)) {
      const [lat, lng, radius] = clip_to_circle.split(',');
      options.clipToCircle = {
        center: utilisation.parseCoordinates(lat, lng),
        radius: parseFloat(radius),
      };
    }
    if (!utilisation.isEmpty(clip_to_polygon)) {
      options.clipToPolygon = utilisation.convertToCoordinates(clip_to_polygon);
    }
    return options;
  }
  /**
  ...
  async getAutosuggestions(value) {
    ...
    return this.clients.autosuggest.run(options).finally(() => {
      ...
      utilisation.utilisation.send({
        key: api_key,
        baseUrl: base_url,
        type: utilisation.SessionType.Updated,
  ...
  onValueChanged({ detail: { value } }) {
    ...
    this.setSelectedSuggestion(index.DEFAULTS.null);
    this.setRawInput(value);
    const valid = index.W3W_REGEX.test(value);
    if (valid) {
      const [, words] = index.W3W_REGEX.exec(value);
      this.setValue(words);
      this.value_valid.emit({
        value: index.DEFAULTS.prefix + words,
      });
    }
    else {
      this.setValue(value);
  ...
  async onSelectedSuggestion({ detail: { suggestion } }) {
    if (this.getInputElement()) {
      this.setInputValue(index.DEFAULTS.prefix + suggestion.words);
    }
  ...
  _onBlur() {
    ...
    if (isInputChanged && !this.getSelectedSuggestion() && this.strict) {
      this.setInputValue(index.DEFAULTS.emptyString);
      this.setValue(index.DEFAULTS.emptyString);
      this.emitInvalidAddressError();
    }
    else if (!this.strict &&
      this.getInputElement().value === index.DEFAULTS.prefix) {
      this.setInputValue(index.DEFAULTS.emptyString);
      this.setValue(index.DEFAULTS.emptyString);
    }
  ...
  onPaste(event) {
    ...
    const isValid3wa = index.W3W_REGEX.test(pastedText);
    let value;
    if (isValid3wa) {
      const [, words] = index.W3W_REGEX.exec(pastedText);
      value = index.DEFAULTS.prefix + words;
    }
    else {
  ...
  onFocus(e) {
    const input = this.getInputElement();
    if (e.target.value === '' || e.target.value === index.DEFAULTS.prefix) {
      e.target.value = index.DEFAULTS.prefix;
    }
  ...
  connectedCallback() {
    ...
    const input = host.querySelector(index.SELECTORS.input);
    ...
    const transport = index.dist.fetchTransport();
    this.clients = {
      autosuggest: index.what3wordsClients.autosuggest(this.api_key, config, transport),
      convertToCoordinates: index.what3wordsClients.convertToCoordinates(this.api_key, config, transport),
    };
    utilisation.utilisation.send({
      key: api_key,
      baseUrl: base_url,
      type: utilisation.SessionType.Started,
      headers,
      data: {
        return_coordinates,
        typeahead_delay,
  ...
  async componentWillLoad() {
    ...
    if (index.W3W_REGEX.test(initial_value)) {
  ...
  render() {
    ...
    return (index$1.h(index$1.Host, { class: variant }, index$1.h("div", { class: c + ' ' + variant }, index$1.h("div", { class: `${c}-input-wrapper`, "data-testid": "input-wrapper" }, index$1.h("slot", null), index$1.h(Status$1, { class: state, offsetHeight: (_a = input === null || input === void 0 ? void 0 : input.offsetHeight) !== null && _a !== void 0 ? _a : null })), index$1.h(Suggestions$1, { class: visible, value: this.getValue(), hoverIndex: this.getHoverIndex(), suggestions: suggestions, options: options, offsetWidth: (_b = input === null || input === void 0 ? void 0 : input.offsetWidth) !== null && _b !== void 0 ? _b : null, onW3wSuggestionSelected: onClick.bind(this), onCustomOptionSelected: onCustomClick.bind(this), onMouseOver: onMouseOver.bind(this), onMouseOut: onMouseOut.bind(this) }), index$1.h(ErrorMessage, { error: error, offsetWidth: (_c = input === null || input === void 0 ? void 0 : input.offsetWidth) !== null && _c !== void 0 ? _c : null }))));
  }
...
What3wordsAutosuggest.style = autosuggestCss;
...
class GoogleMaps extends MapProvider {
  constructor() {
    super(...arguments);
    this.grid = [];
    this.map = null;
  ...
  plotGrid(grid, onClick) {
    this.grid = grid.lines.map((line, index$1) => {
      ...
      this.eventListeners[`grid-${index$1}`] = gridline.addListener('click', async (e) => {
        const coordinates = e.latLng.toJSON();
        const zoom = this.zoom;
        this.panTo(coordinates);
        if (zoom < index.MIN_GRID_ZOOM_LEVEL) {
  ...
  plotMarker(address, callback, markerIcon = index.MARKER_SRC) {
    var _a;
    if (this.marker) {
  ...
  get mapBounds() {
    if (!this.map)
      return index.DEFAULTS.bounds;
    const mapBounds = JSON.parse(JSON.stringify(this.map.getBounds() || index.DEFAULTS.bounds));
    return mapBounds;
  }
  set viewType(type) {
    if (!this.map)
...
const mapCss = "what3words-map{display:block}";

const What3wordsMap = class {
  constructor(hostRef) {
    index$1.registerInstance(this, hostRef);
    this.selected_square = index$1.createEvent(this, "selected_square", 7);
    this.coordinates_changed = index$1.createEvent(this, "coordinates_changed", 7);
    this.__load = index$1.createEvent(this, "__load", 7);
    this.__error = index$1.createEvent(this, "__error", 7);
    var _a;
    this.api_key = index.DEFAULTS.emptyString;
    this.headers = index.DEFAULTS.headers;
    this.base_url = ((_a = index.sdk.api.clients.gridSection['_config']) === null || _a === void 0 ? void 0 : _a.host) || index.DEFAULTS.base_url;
    this.api_version = index.dist.ApiVersion.Version3;
    this.words = index.DEFAULTS.emptyString;
    this.map_provider = 'google';
    this.map_api_key = index.DEFAULTS.emptyString;
    this.version = 'weekly';
    this.libraries = index.DEFAULT_LIBS;
    this.language = 'en';
    this.region = 'GB';
    this.lat = index.DEFAULTS.center.lat;
    this.lng = index.DEFAULTS.center.lng;
    this.tilt = 0;
    ...
    this.search_control_position = index.TOP_LEFT;
    this.current_location_control_position = 0;
    this.selected_zoom = index.SELECTED_ZOOM_LEVEL;
    this.current_location = undefined;
    this.watch_location = undefined;
    this.marker_icon = index.MARKER_SRC;
    ...
    this.input = index.DEFAULTS.null;
    this.autosuggest = index.DEFAULTS.null;
    this.placesSuggestions = [];
    this.request = index.DEFAULTS.null;
    this.watch_id = index.DEFAULTS.null;
  ...
  async setWords(words) {
    if (!index.W3W_REGEX.test(words) || !this.provider)
      return;
    return this.clients.convertToCoordinates
      .run({ words })
      .then((response) => {
  ...
  setSearchControlPosition(position) {
    this.searchControlSlot = this.host.querySelector(index.SEARCH_CONTROL_SELECTOR);
  ...
  setCurrentLocationControlPosition(position) {
    this.currentLocationControlSlot = this.host.querySelector(index.CURRENT_LOCATION_CONTROL_SELECTOR);
  ...
  setMapTypeControlPosition(position) {
    ...
    this.mapTypeControlSlot = this.host.querySelector(index.MAP_TYPE_CONTROL_SELECTOR);
  ...
  setZoomControlPosition(position) {
    ...
    this.zoomControlSlot = this.host.querySelector(index.ZOOM_CONTROL_SELECTOR);
  ...
  validateCoordinates(coordinates) {
    ...
    if (isNaN(coordinates.lat) ||
      ...
      coordinates.lng === 0 ||
      coordinates.lat === 0) {
      return Object.assign(Object.assign({}, coordinates), { lat: index.DEFAULTS.center.lat, lng: index.DEFAULTS.center.lng });
    }
    return coordinates;
  }
  async onLoad() {
    ...
    const searchControl = this.host.querySelector(index.SEARCH_CONTROL_SELECTOR);
  ...
  initProvider(opts = {}) {
    ...
    const mapDiv = this.host.querySelector(index.MAP_SELECTOR);
  ...
  async onCustomSelect(event) {
    ...
    const coordinates = await this.provider
      ...
      this.__error.emit(new ErrorEvent('ServiceError', {
        message: index.DEFAULTS.serviceErrorMessage,
        error,
      }));
      return;
    });
  ...
  onProviderInit() {
    if (!this.provider)
      return;
    const { host } = this;
    this.searchControlSlot = host.querySelector(index.SEARCH_CONTROL_SELECTOR);
    this.currentLocationControlSlot = host.querySelector(index.CURRENT_LOCATION_CONTROL_SELECTOR);
    this.mapTypeControlSlot = host.querySelector(index.MAP_TYPE_CONTROL_SELECTOR);
    this.zoomControlSlot = host.querySelector(index.ZOOM_CONTROL_SELECTOR);
    this.autosuggest = this.searchControlSlot
      ? this.searchControlSlot.querySelector(index.AUTOSUGGEST_SELECTOR)
      : null;
    this.input = this.autosuggest
      ? this.autosuggest.querySelector(index.SELECTORS.input)
      : null;
  ...
  connectedCallback() {
    ...
    // Initialise provider
    const mapDiv = host.querySelector(index.MAP_SELECTOR);
    this.searchControlSlot = host.querySelector(index.SEARCH_CONTROL_SELECTOR);
    ...
    this.clients = {
      convertToCoordinates: index.what3wordsClients.convertToCoordinates(this.api_key, config, transport),
      convertTo3wa: index.what3wordsClients.convertTo3wa(this.api_key, config, transport),
      gridSection: index.what3wordsClients.gridSection(this.api_key, config, transport),
    };
  }
  disconnectedCallback() {
    var _a;
  ...
  render() {
    ...
    return (index$1.h(index$1.Host, null, index$1.h("slot", { name: "map" }), index$1.h("div", { id: "controls-wrapper", "data-testid": "controls-wrapper", "aria-hidden": ariaHidden, style: controlsWrapperStyle }, index$1.h("slot", { name: "search-control" }), index$1.h("slot", { name: "map-type-control" }), index$1.h("slot", { name: "zoom-control" }), index$1.h("slot", { name: "current-location-control" }))));
  }
  get host() { return index$1.getElement(this); }
  static get watchers() { return {
    "api_key": ["setApiKey"],
...
const W3wSuggestion = (_a) => {
  var { tag, opt } = _a, props = __rest$1(_a, ["tag", "opt"]);
  return (index$1.h("li", Object.assign({}, props),
    index$1.h("div", { class: `${tag}-address`, "data-testid": "address" },
      index$1.h("what3words-symbol", { size: 14, color: index.DEFAULTS.iconColor }),
      index$1.h("div", { class: `${tag}-words`, "data-testid": "words" }, opt.words)),
    index$1.h("div", { class: `${tag}-nearest-place`, "data-testid": "nearest-place" },
      index$1.h("div", { class: `${tag}-nearest-place-text`, "data-testid": "nearest-place-text" }, opt.nearestPlace ? (opt.nearestPlace) : (index$1.h("img", { class: `${tag}-sea-icon`, src: seaSvg, alt: "Ocean" }))),
      !isNaN(opt.distanceToFocusKm) && (index$1.h("div", { class: `${tag}-nearest-place-distance`, "data-testid": "nearest-place-distance" },
        opt.distanceToFocusKm,
        "km")))));
};
...
const W3wSuggestions = ({ tag, suggestions, value, hoverIndex, onSuggestionSelected, onMouseOver, onMouseOut, }) => {
  return suggestions.map((opt, i) => {
    const onMouseDown = (e) => e.preventDefault();
    return (index$1.h(W3wSuggestion, { key: opt.words, class: {
        [`${tag}-item`]: !!tag,
...
const W3wSuggestionsSkeleton = ({ tag, }) => (index$1.h(index$1.Fragment, null,
  index$1.h("li", { class: { [`${tag}-suggestion-skeleton`]: !!tag } },
    index$1.h("img", { src: suggestionSkeletonSvg, alt: "suggestion skeleton" })),
  index$1.h("li", { class: { [`${tag}-suggestion-skeleton`]: !!tag } },
    index$1.h("img", { src: suggestionSkeletonSvg, alt: "suggestion skeleton" })),
  index$1.h("li", { class: { [`${tag}-suggestion-skeleton`]: !!tag } },
    index$1.h("img", { src: suggestionSkeletonSvg, alt: "suggestion skeleton" }))));
const Suggestions = (_a) => {
  ...
  return (index$1.h("ul", { "data-testid": `${tag}-suggestions`, class: { [`${tag}-suggestions`]: !!tag }, 
    // Dynamically settings the width of the suggestions if there is an input. If you change the size of the
    // border in autosuggest.scss you must also change it here accordingly.
    style: props.style },
    showSkeleton && index$1.h(W3wSuggestionsSkeleton, { tag: tag }),
    showSuggestions && (index$1.h(W3wSuggestions, { tag: tag, suggestions: suggestions, value: value, hoverIndex: hoverIndex, onMouseOver: onMouseOver, onMouseOut: onMouseOut, onSuggestionSelected: onSuggestionSelected })),
    showHeader && index$1.h(Header, { tag: tag, onClose: onClose })));
};

const Tooltip = ({ tag, style, onClose, }) => {
  return (index$1.h("section", { class: { [`${tag}-tooltip`]: !!tag }, style: style },
    index$1.h(Header, { tag: tag, onClose: onClose, style: {
        backgroundColor: 'white',
        borderRadius: '0.5rem',
        margin: '-8px -8px 0 -8px',
      } }),
    index$1.h("slot", { name: "tooltip" },
      index$1.h("h3", { class: { [`${tag}-tooltip-title`]: !!tag } }, "Did you know?"),
      index$1.h("p", { class: { [`${tag}-tooltip-description`]: !!tag } },
        "You can add a",
        ' ',
        index$1.h("a", { href: "https://delivery.w3w.co", target: "_blank", rel: "noopener noreferrer" }, "what3words"),
        ' ',
...
const What3wordsNotes = class {
  constructor(hostRef) {
    ...
    this.apiKey = '';
    this.headers = '{}';
    this.baseUrl = (_b = (_a = index.sdk.api.clients.autosuggest['_config']) === null || _a === void 0 ? void 0 : _a.host) !== null && _b !== void 0 ? _b : 'https://api.what3words.com';
    this.apiVersion = 'v3';
  ...
  async getRequestOptions(input) {
    ...
    if (!utilisation.isEmpty(this.nFocusResults)) {
      options.nFocusResults = this.nFocusResults;
    }
    if (!utilisation.isEmpty(this.clipToCountry)) {
      options.clipToCountry = this.clipToCountry.split(',');
    }
    if (!utilisation.isEmpty(this.clipToBoundingBox)) {
    ...
    if (!utilisation.isEmpty(this.clipToCircle)) {
    ...
    if (!utilisation.isEmpty(this.clipToPolygon)) {
      options.clipToPolygon = utilisation.convertToCoordinates(this.clipToPolygon);
    }
    return options;
  }
  /**
  ...
  emitFatalError() {
    var _a;
    this.apiError.emit({
      error: new Error((_a = t('error_message')) !== null && _a !== void 0 ? _a : index.DEFAULTS.fatalErrorMessage),
    });
  }
  clearApiError() {
  ...
  isValid3wa(value) {
    return index.W3W_REGEX.test(value);
  }
  extract3wa(value) {
    const [, words] = index.W3W_REGEX.exec(value);
    return words;
  ...
  matchSelected3waFromInputSlot() {
    ...
    const w3wFromInput = ((_a = inputSlot.value) === null || _a === void 0 ? void 0 : _a.trim().length) === 0
      ? []
      : (_c = (_b = inputSlot.value) === null || _b === void 0 ? void 0 : _b.match(index.W3W_TEXTAREA_REGEX)) !== null && _c !== void 0 ? _c : [];
  ...
  findW3wAtCursorPosition(inputSlot) {
    ...
    const inputValue = inputSlot.value;
    const w3wFromInput = inputValue.match(index.W3W_TEXTAREA_REGEX);
    if (!w3wFromInput)
      return { w3w: '' };
  ...
  async connectedCallback() {
    ...
    const transport = await Promise.resolve().then(function () { return require('./index-c80d121f.js'); }).then(function (n) { return n.index; }).then(m => m.fetchTransport());
    if (!this.apiKey) {
      throw new Error('a What3words API key is required, you can get one at https://accounts.what3words.com/select-plan');
    }
    this.clients = {
      autosuggest: index.what3wordsClients.autosuggest(this.apiKey, config, transport),
      convertToCoordinates: index.what3wordsClients.convertToCoordinates(this.apiKey, config, transport),
    };
  }
  disconnectedCallback() {
    clearTimeout(this.apiRequest);
  ...
  getCursorPosition(inputSlot) {
    ...
    index.W3W_TEXTAREA_PROPERTIES.forEach(prop => {
  ...
  render() {
    ...
    return (index$1.h(index$1.Host, { class: {
      ...
      } }, index$1.h("fieldset", { class: { [`${tag}-input-wrapper`]: !!tag }, "data-testid": "input-wrapper" }, index$1.h("div", { class: { [`${tag}-label`]: !!tag } }, index$1.h("slot", { name: "label" }), index$1.h(Status, { tag: tag, isLoadingSelected3waCount: isLoadingSelected3waCount, selected3waCount: selected3waCount, showHintsTooltip: this.showHintsTooltip, toggleTooltip: () => this.tooltipOpen ? this.closeTooltip() : this.openTooltip() })), index$1.h("slot", { name: "input" }), index$1.h(Tooltip, { tag: tag, onClose: () => this.closeTooltip() })), index$1.h(Suggestions, { style: suggestionsStyle, tag: tag, value: value, hoverIndex: this.hoverIndex, loading: isLoading, suggestions: this.suggestions, onSuggestionSelected: onSuggestionSelected.bind(this), onMouseOver: onMouseOver.bind(this), onMouseOut: onMouseOut.bind(this), onClose: () => this.hideSuggestions() })));
  }
  get host() { return index$1.getElement(this); }
  static get watchers() { return {
    "apiKey": ["setApiKey"],
...
What3wordsNotes.style = notesCss;

const symbolCss = "@import url(\"https://fonts.googleapis.com/css?family=Source+Sans+Pro&display=swap\");what3words-symbol{display:-ms-inline-flexbox;display:inline-flex;-ms-flex-pack:center;justify-content:center;-ms-flex-align:center;align-items:center;font-family:\"Source Sans Pro\";font-style:normal;font-weight:normal;font-size:18px;line-height:23px}what3words-symbol .what3words-logo{display:inline-block}";

const What3wordsSymbol = class {
  constructor(hostRef) {
    index$1.registerInstance(this, hostRef);
    this.color = index.DEFAULTS.iconColor;
    this.size = index.DEFAULTS.symbolSize;
  }
  render() {
    return (index$1.h(index$1.Host, null, index$1.h("svg", { viewBox: "0 0 32 32", class: "what3words-logo", style: {
        color: this.color,
        width: `${this.size}px`,
        height: `${this.size}px`,
      }, "data-testid": "what3words-symbol" }, index$1.h("path", { fill: "currentColor", d: "M10.7,4h2L4,28H2L10.7,4z M19.7,4h2L13,28h-2L19.7,4z M28.7,4h2L22,28h-2L28.7,4z" }))));
  }
};
What3wordsSymbol.style = symbolCss;

exports.what3words_autosuggest = What3wordsAutosuggest;
exports.what3words_map = What3wordsMap;
exports.what3words_notes = What3wordsNotes;
exports.what3words_symbol = What3wordsSymbol;
