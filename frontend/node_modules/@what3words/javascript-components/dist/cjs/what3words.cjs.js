...
const index = require('./index-c574deb6.js');
const appGlobals = require('./app-globals-470d1069.js');
require('./index-c80d121f.js');
require('./utilisation-9fc0aaea.js');

/*
 Stencil Client Patch Browser v3.1.0 | MIT Licensed | https://stenciljs.com
 */
const patchBrowser = () => {
    const importMeta = (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('what3words.cjs.js', document.baseURI).href));
    const opts = {};
